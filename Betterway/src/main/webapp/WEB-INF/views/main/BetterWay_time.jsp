...
var a=	$("#selstation option:selected").val();
	...
	$.ajax({
		// http://openAPI.seoul.go.kr:8088/72717a744e70626237346774787358/json/SearchSTNTimeTableByIDService/1/5/0309/1/1/
			url: "http://openAPI.seoul.go.kr:8088/72717a744e70626237346774787358/json/SearchSTNTimeTableByIDService/1/500/"+a+"/"+b+"1/", // 접속 주소
		...
		var time = res.SearchSTNTimeTableByIDService.row[i].LEFTTIME.substring(0,2);
		var timem = res.SearchSTNTimeTableByIDService.row[i].LEFTTIME.substring(3,5);
	var end = 	res.SearchSTNTimeTableByIDService.row[i].SUBWAYENAME
		
				if(time == "05"){
				  $('td[name="05상"]').prepend(timem,"("+ end +")</br>");
				
				}
				else if(time == "06"){
				  $('td[name="06상"]').prepend(timem,"("+ end +")</br>");
				
				}
				else if(time == "07"){
					  $('td[name="07상"]').prepend(timem,"("+ end +")</br>");
					
					}
				else if(time == "08"){
					  $('td[name="08상"]').prepend(timem,"("+ end +")</br>");
					
					}
				else if(time == "09"){
					  $('td[name="09상"]').prepend(timem,"("+ end +")</br>");
					
					}
				else if(time == "10"){
					  $('td[name="10상"]').prepend(timem,"("+ end +")</br>");
					
					}
				else if(time == "11"){
					  $('td[name="11상"]').prepend(timem,"("+ end +")</br>");
					
					}
				else if(time == "12"){
					  $('td[name="12상"]').prepend(timem,"("+ end +")</br>");
					
					}
				else if(time == "13"){
					  $('td[name="13상"]').prepend(timem,"("+ end +")</br>");
					
					}
				else if(time == "14"){
					  $('td[name="14상"]').prepend(timem,"("+ end +")</br>");
					
					}
				else if(time == "15"){
					  $('td[name="15상"]').prepend(timem,"("+ end +")</br>");
					
					}
				else if(time == "16"){
					  $('td[name="16상"]').prepend(timem,"("+ end +")</br>");
					
					}
				else if(time == "17"){
					  $('td[name="17상"]').prepend(timem,"("+ end +")</br>");
					
					}
				else if(time == "18"){
					  $('td[name="18상"]').prepend(timem,"("+ end +")</br>");
					
					}
				else if(time == "19"){
					  $('td[name="19상"]').prepend(timem,"("+ end +")</br>");
					
					}
				else if(time == "20"){
					  $('td[name="20상"]').prepend(timem,"("+ end +")</br>");
					
					}
				else if(time == "21"){
					  $('td[name="21상"]').prepend(timem,"("+ end +")</br>");
					
					}	
				else if(time == "22"){
					  $('td[name="22상"]').prepend(timem,"("+ end +")</br>");
					
					}	
				else if(time == "23"){
					  $('td[name="23상"]').prepend(timem,"("+ end +")</br>");
	...
	$.ajax({
		// http://openAPI.seoul.go.kr:8088/72717a744e70626237346774787358/json/SearchSTNTimeTableByIDService/1/5/0309/1/1/
			url: "http://openAPI.seoul.go.kr:8088/72717a744e70626237346774787358/json/SearchSTNTimeTableByIDService/1/500/"+a+"/"+b+"2/", // 접속 주소
			type: "get", // 전송방식 : get, post
			dataType: "json",
			success: function(res) { // 성공 시 다음 함수 실행
				for(var i=0; i<res.SearchSTNTimeTableByIDService.row.length; i++){
					...
					if(time == "05"){
						  $('td[name="05하"]').prepend(timem,"("+ end +")</br>");
						
						}
						else if(time == "06"){
						  $('td[name="06하"]').prepend(timem,"("+ end +")</br>");
						
						}
						else if(time == "07"){
							  $('td[name="07하"]').prepend(timem,"("+ end +")</br>");
							
							}
						else if(time == "08"){
							  $('td[name="08하"]').prepend(timem,"("+ end +")</br>");
							
							}
						else if(time == "09"){
							  $('td[name="09하"]').prepend(timem,"("+ end +")</br>");
							
							}
						else if(time == "10"){
							  $('td[name="10하"]').prepend(timem,"("+ end +")</br>");
							
							}
						else if(time == "11"){
							  $('td[name="11하"]').prepend(timem,"("+ end +")</br>");
							
							}
						else if(time == "12"){
							  $('td[name="12하"]').prepend(timem,"("+ end +")</br>");
							
							}
						else if(time == "13"){
							  $('td[name="13하"]').prepend(timem,"("+ end +")</br>");
							
							}
						else if(time == "14"){
							  $('td[name="14하"]').prepend(timem,"("+ end +")</br>");
							
							}
						else if(time == "15"){
							  $('td[name="15하"]').prepend(timem,"("+ end +")</br>");
							
							}
						else if(time == "16"){
							  $('td[name="16하"]').prepend(timem,"("+ end +")</br>");
							
							}
						else if(time == "17"){
							  $('td[name="17하"]').prepend(timem,"("+ end +")</br>");
							
							}
						else if(time == "18"){
							  $('td[name="18하"]').prepend(timem,"("+ end +")</br>");
							
							}
						else if(time == "19"){
							  $('td[name="19하"]').prepend(timem,"("+ end +")</br>");
							
							}
						else if(time == "20"){
							  $('td[name="20하"]').prepend(timem,"("+ end +")</br>");
							
							}
						else if(time == "21"){
							  $('td[name="21하"]').prepend(timem,"("+ end +")</br>");
							
							}	
						else if(time == "22"){
							  $('td[name="22하"]').prepend(timem,"("+ end +")</br>");
							
							}	
						else if(time == "23"){
							  $('td[name="23하"]').prepend(timem,"("+ end +")</br>");
...
<tr >
<th>
<input type="button" id="dateBtn1" value="평일" >
</th> 
<th>
<input type="button" id="dateBtn2" value="토요일">
</th>
 <th>
 <input type="button"  id="dateBtn3" value="공휴일">
 </th>
</tr>
<tr>
<th scope="col">
