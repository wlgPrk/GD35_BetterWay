										 ...
										 $("#endX").val(d.LNG);
												...
												$.ajax({
													...
													success: function(res) {
														...
														var html ="";
														var time ="";
														 time = $(res.data).find("itemList").eq(0).find("time").text();
													console.log(time);
														$("#take_P").html(time);//소요시간 뿌림
														
														
														var pathListCnt= $(res.data).find("itemList").eq(0).find("routeNm").text();
														...
														console.log($(res.data).find("itemList").eq(0));
														
														 $(res.data).find("itemList").eq(0).find('pathList').each(function(){
